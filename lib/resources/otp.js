...
class OTP extends ApiBase {
    ...
    sendOtp( parameters ) {
        ...
        if ( deliveryType === this.DeliveryTypes.voice && typeof template !== 'undefined' ) {

            throw new Error( 'You can not choose a template when delivering a voice OTP.' );

        }

        if ( template && typeof template !== 'string' ) {

            throw new TypeError( `"template": was expecting a string, got ${ typeof template }` );
    ...
    verifyOtp( parameters ) {
        ...
        if ( typeof sessionId !== 'string' ) {
            ...
            throw new TypeError(
                `"sessionId": was expecting a string, got ${ typeof sessionId }`
            );
